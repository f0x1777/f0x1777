...
<h1 align="center">Hey, I'm Nico — they call me f0x 🦊</h1>
...
<p>
  <img src="https://skillicons.dev/icons?i=rust,typescript,python,bash,nextjs,nodejs,postgres,supabase,docker,kubernetes,linux,vercel,tailwind,git,vim&perline=15" alt="stack icons" />
</p>

<p>
  <img src="https://img.shields.io/badge/Solana-14F195?style=flat-square&logo=solana&logoColor=000" alt="Solana"/>
  <img src="https://img.shields.io/badge/Anchor-512da8?style=flat-square" alt="Anchor"/>
  <img src="https://img.shields.io/badge/gRPC-244c5a?style=flat-square&logo=google&logoColor=white" alt="gRPC"/>
  <img src="https://img.shields.io/badge/Geyser-00d4aa?style=flat-square&labelColor=0a0a0a" alt="Geyser"/>
  <img src="https://img.shields.io/badge/Yellowstone-fbbf24?style=flat-square&labelColor=0a0a0a" alt="Yellowstone"/>
</p>
...
- **English · Spanish** — fluent (daily ops, code reviews, customer calls)
- **Italian · French** — enough to order wine and argue about why a Mendoza Malbec beats a Cabernet Franc from the Loire (it does)
- When all else fails — *asado.*
...
**Best for:** Solana infra collaboration · agentic dev tooling · technical conversations
**Slow for:** cold sales · syncs without an agenda
